...
## Casual Clothes
image echappy_button = Crop((170, 245, 290, 290), "eileen happy")
image ecneutral_button = Crop((170, 245, 290, 290), "eileen neutral")
image ecsurprised_button = Crop((170, 245, 290, 290), "eileen surprised")
image ecupset_button = Crop((170, 245, 290, 290), "eileen upset")
image ecangry_button = Crop((170, 245, 290, 290), "eileen angry")
## Summer Clothes
image eshappy_button = Crop((170, 245, 290, 290), "eileen summer happy")
image esneutral_button = Crop((170, 245, 290, 290), "eileen summer neutral")
image essurprised_button = Crop((170, 245, 290, 290), "eileen summer surprised")
image esupset_button = Crop((170, 245, 290, 290), "eileen summer upset")
image esangry_button = Crop((170, 245, 290, 290), "eileen summer angry")
## Locked Button
...
transform gallery_offset:
    yoffset 200

image gallery eileen happy:
    "eileen happy"
    gallery_offset

image gallery eileen neutral:
    "eileen neutral"
    gallery_offset

image gallery eileen surprised:
    "eileen surprised"
    gallery_offset

image gallery eileen upset:
    "eileen upset"
    gallery_offset

image gallery eileen angry:
    "eileen angry"
    gallery_offset

image gallery eileen summer neutral:
    "eileen summer neutral"
    gallery_offset

image gallery eileen summer happy:
    "eileen summer happy"
    gallery_offset
...
init python:
    ...
    ## Normally, you can use the unlock_image property to have the contents of the image in one go
    # g_sprite.unlock_image("room", "eileen happy")
    g_sprite.image("room", "gallery eileen happy")
    g_sprite.unlock("room", "eileen happy")
    g_sprite.button("eileen neutral")
    g_sprite.image("room", "gallery eileen neutral")
    g_sprite.unlock("room", "eileen surprised")
    g_sprite.button("eileen surprised")
    g_sprite.image("room", "gallery eileen surprised")
    g_sprite.unlock("room", "eileen surprised")
    g_sprite.button("eileen upset")
    g_sprite.image("room", "gallery eileen upset")
    g_sprite.unlock("room", "eileen upset")
    g_sprite.button("eileen angry")
    g_sprite.image("room", "gallery eileen angry")
    g_sprite.unlock("room", "eileen angry")
    ###Summer
    g_sprite.button("eileen summer happy")
    g_sprite.image("sort_of_beautiful_beach_day", "gallery eileen summer happy")
    ## If the condition below is true, show the image above
    g_sprite.condition("persistent.swimsuit_unlock")
    g_sprite.button("eileen summer neutral")
    g_sprite.image("sort_of_beautiful_beach_day", "gallery eileen summer neutral")
    g_sprite.condition("persistent.swimsuit_unlock")
    ...
    # Add music files. The order you put these in actually do matter for the
    # Previous and Next button actions.
    mr.add("audio/music/The-Concrete-Bakes_Looping.mp3", always_unlocked=True)
    mr.add("audio/music/Sculpture-Garden_Looping.mp3")
    mr.add("audio/music/Future-Business_v001.mp3")
    mr.add("audio/music/Careless-Summer_Looping.mp3")
...
screen sprite_gallery():
    ...
    use extras_menu(_("Sprite Gallery")):
        ...
        grid 4 2:
            ...
            add g_sprite.make_button("eileen happy", "echappy_button")
            add g_sprite.make_button("eileen neutral", "ecneutral_button")
            add g_sprite.make_button("eileen surprised", "ecsurprised_button")
            add g_sprite.make_button("eileen upset", "ecupset_button")

            add g_sprite.make_button("eileen angry", "ecangry_button")
            add g_sprite.make_button("eileen summer happy", "eshappy_button")
            add g_sprite.make_button("eileen summer neutral", "esneutral_button")
            text "" ## This leaves a blank space in our grid.
...
screen music_gallery():
    ...
    use extras_menu(_("Music Room")):
        ...
        vbox:
            ...
            # The buttons that play each track. Be sure to match with the order
            # you defined your Music Room definitions.
            ...
            ## TODO: If I may, I'd suggest using a list for players to write out the track paths
            ## and perhaps a dictionary of track-name-to-button-name so you can just iterate over them
...
Feniks
\n
Matthew Vimislik (AKA Visual Novel Design)
\n
Renall
\n\n\n\n\n\n\n\n
{size=+75}Made with Ren'Py [renpy.version_only].{/size}\n\n\n\n
